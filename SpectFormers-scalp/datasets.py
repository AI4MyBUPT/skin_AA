...
def build_transform(is_train, args, infer_no_resize=False):
    ...
    if is_train:
        ...
        transform = create_transform(
            ...
            is_training=True,
            color_jitter=0.4, #args.color_jitter,   #default=0.4
            auto_augment='rand-m9-mstd0.5-inc1', # args.aa,  #default='rand-m9-mstd0.5-inc1'
            interpolation='bicubic', # args.train_interpolation, #default='bicubic'
            re_prob=0, # args.reprob,  # default=0
            re_mode='pixel',  #args.remode,   #default='pixel'
            re_count=1  # args.recount,   #default=1
        )
        if not resize_im:
